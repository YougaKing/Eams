...
public class FragmentLifecycle extends FragmentManager.FragmentLifecycleCallbacks {
    ...
    public void onFragmentPreAttached(FragmentManager fragmentManager, Fragment fragment, Context context) {
        ...
        fragmentFunctionDispatcher.onFragmentAttached(fragment.getActivity(), fragment, "onFragmentPreAttached", TimeUtils.currentTimeMillis());
    ...
    public void onFragmentAttached(FragmentManager fragmentManager, Fragment fragment, Context context) {
        ...
        fragmentFunctionDispatcher.onFragmentAttached(fragment.getActivity(), fragment, "onFragmentAttached", TimeUtils.currentTimeMillis());
    ...
    public void onFragmentPreCreated(FragmentManager fragmentManager, Fragment fragment, Bundle bundle) {
        ...
        fragmentFunctionDispatcher.onFragmentAttached(fragment.getActivity(), fragment, "onFragmentPreCreated", TimeUtils.currentTimeMillis());
    ...
    public void onFragmentCreated(FragmentManager fragmentManager, Fragment fragment, Bundle bundle) {
        ...
        fragmentFunctionDispatcher.onFragmentAttached(fragment.getActivity(), fragment, "onFragmentCreated", TimeUtils.currentTimeMillis());
    ...
    public void onFragmentActivityCreated(FragmentManager fragmentManager, Fragment fragment, Bundle bundle) {
        ...
        fragmentFunctionDispatcher.onFragmentAttached(fragment.getActivity(), fragment, "onFragmentActivityCreated", TimeUtils.currentTimeMillis());
    ...
    public void onFragmentViewCreated(FragmentManager fragmentManager, Fragment fragment, View view, Bundle bundle) {
        ...
        fragmentFunctionDispatcher.onFragmentAttached(fragment.getActivity(), fragment, "onFragmentViewCreated", TimeUtils.currentTimeMillis());
    ...
    public void onFragmentStarted(FragmentManager fragmentManager, Fragment fragment) {
        ...
        fragmentFunctionDispatcher.onFragmentAttached(fragment.getActivity(), fragment, "onFragmentStarted", TimeUtils.currentTimeMillis());
    ...
    public void onFragmentResumed(FragmentManager fragmentManager, Fragment fragment) {
        ...
        fragmentFunctionDispatcher.onFragmentAttached(fragment.getActivity(), fragment, "onFragmentResumed", TimeUtils.currentTimeMillis());
    ...
    public void onFragmentPaused(FragmentManager fragmentManager, Fragment fragment) {
        ...
        fragmentFunctionDispatcher.onFragmentAttached(fragment.getActivity(), fragment, "onFragmentPaused", TimeUtils.currentTimeMillis());
    ...
    public void onFragmentStopped(FragmentManager fragmentManager, Fragment fragment) {
        ...
        fragmentFunctionDispatcher.onFragmentAttached(fragment.getActivity(), fragment, "onFragmentStopped", TimeUtils.currentTimeMillis());
    ...
    public void onFragmentSaveInstanceState(FragmentManager fragmentManager, Fragment fragment, Bundle bundle) {
        ...
        fragmentFunctionDispatcher.onFragmentAttached(fragment.getActivity(), fragment, "onFragmentSaveInstanceState", TimeUtils.currentTimeMillis());
    ...
    public void onFragmentViewDestroyed(FragmentManager fragmentManager, Fragment fragment) {
        ...
        fragmentFunctionDispatcher.onFragmentAttached(fragment.getActivity(), fragment, "onFragmentViewDestroyed", TimeUtils.currentTimeMillis());
    ...
    public void onFragmentDestroyed(FragmentManager fragmentManager, Fragment fragment) {
        ...
        fragmentFunctionDispatcher.onFragmentAttached(fragment.getActivity(), fragment, "onFragmentDestroyed", TimeUtils.currentTimeMillis());
    ...
    public void onFragmentDetached(FragmentManager fragmentManager, Fragment fragment) {
        ...
        fragmentFunctionDispatcher.onFragmentAttached(fragment.getActivity(), fragment, "onFragmentDetached", TimeUtils.currentTimeMillis());
