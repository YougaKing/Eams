...
public class GzipUtils {
    ...
    public static byte[] gzipAndRc4Bytes(java.lang.String r7) {
        /*
            ...
            r3.<init>(r0)     // Catch:{ IOException -> 0x002c }
            java.lang.String r5 = "UTF-8"
            byte[] r5 = r7.getBytes(r5)     // Catch:{ IOException -> 0x0046, all -> 0x0043 }
            r3.write(r5)     // Catch:{ IOException -> 0x0046, all -> 0x0043 }
            r3.flush()     // Catch:{ IOException -> 0x0046, all -> 0x0043 }
            if (r3 == 0) goto L_0x0049
            r3.close()     // Catch:{ Exception -> 0x0029 }
            r2 = r3
        L_0x001d:
            byte[] r5 = r0.toByteArray()
            byte[] r4 = com.alibaba.motu.tbrest.utils.RC4.rc4(r5)
