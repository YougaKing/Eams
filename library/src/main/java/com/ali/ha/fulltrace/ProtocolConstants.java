...
public class ProtocolConstants {
    ...
    public static void getDocTypeDescriptor() {
        ...
        List arrayList = new ArrayList(tmpMap.entrySet());
        Collections.sort(arrayList, new Comparator() {
            public int compare(Object o1, Object o2) {
                Entry obj1 = (Entry)o1;
                Entry obj2 = (Entry)o2;
                return Integer.valueOf((String)obj1.getKey()).compareTo(Integer.valueOf((String)obj2.getKey()));
            }
        });
        Logger.i("ProtocolConstants", new Object[]{"*type-descriptors"});
        Iterator itr = arrayList.iterator();

        while(itr.hasNext()) {
            Entry entry = (Entry)itr.next();
            Logger.i("ProtocolConstants", new Object[]{String.format("0x%04X", Integer.valueOf((String)entry.getKey())) + "=" + entry.getValue()});
        }

        Logger.i("ProtocolConstants", new Object[]{"*end"});
    }
}
